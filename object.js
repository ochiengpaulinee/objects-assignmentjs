...
console.log(peopleAdults(people))
...
//a student with a name and an array of scores,
// write a function that returns a new array containing 
...
const students = [
  ...
  function averageMarks(students){
    ...
    const sumScores = x.scores.reduce((total,score)=>total+score,0)/x.scores.length;
        if(sumScores>=85){
            avg.push(x.name)
        }
...
//write a function that takes the car object and adds a 
//new method to the object called age. 
